...
runTests: BackendDeveloperTests.java
	javac --module-path ../javafx/lib --add-modules javafx.controls -cp .:../junit5fx.jar:.:../junit5.jar BackendDeveloperTests.java
	java --module-path ../javafx/lib --add-modules javafx.controls --add-opens javafx.graphics/com.sun.javafx.application=All-UNNAMED -jar ../junit5fx.jar;../junit5.jar -cp . -c BackendDeveloperTests
clean: 
	rm *.class
